...
public class PlayerController {
  ...
  private static final List<String> ALLOWED_SORTS =
      List.of("name", "position", "jerseyNumber", "dateOfBirth", "nationality");
  ...
  public ResponseEntity<PlayerResponseDTO> updatePlayer(
      @PathVariable Long id, @Valid @RequestBody PlayerRequestDTO requestDTO) {
  ...
  public ResponseEntity<PageResponseDTO<PlayerResponseDTO>> searchPlayers(
      @ParameterObject PlayerSearchDTO criteria) {
    ...
    Page<PlayerResponseDTO> page =
        playerService.searchPlayers(
            criteria.getPosition(), criteria.getName(), criteria.getNationality(), sortedPageable);
