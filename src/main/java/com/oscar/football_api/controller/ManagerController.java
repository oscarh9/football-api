...
public class ManagerController {
  ...
  private static final List<String> ALLOWED_SORTS =
      List.of("name", "nationality", "dateOfBirth", "titlesWon");
  ...
  public ResponseEntity<ManagerResponseDTO> updateManager(
      @PathVariable Long id, @Valid @RequestBody ManagerRequestDTO requestDTO) {
  ...
  public ResponseEntity<PageResponseDTO<ManagerResponseDTO>> searchManagers(
      @ParameterObject ManagerSearchDTO criteria) {
    ...
    Page<ManagerResponseDTO> page =
        managerService.searchManagers(
            criteria.getName(), criteria.getNationality(), criteria.getClubName(), sortedPageable);
